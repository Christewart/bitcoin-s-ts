...
export class ContractDetailComponent implements OnInit {
  ...
  buildChart() {
    if (this.isNumeric()) {
      ...
      const unit = (<NumericEventDescriptor>this.contractInfo.oracleInfo.single.oracleAnnouncement.event.descriptor).unit
      ...
      if (r.result) {
        ...
        this.messsageService.sendMessage(getMessageBody(WalletMessageType.executedlc, 
          ...
          if (r.result) { // closingTxId
            const txId = r.result
            const eventId = this.contractInfo.oracleInfo.single.oracleAnnouncement.event.eventId
